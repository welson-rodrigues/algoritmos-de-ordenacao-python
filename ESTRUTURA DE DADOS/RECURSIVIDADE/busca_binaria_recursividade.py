...
if resultado != -1:
    ...
    print(f"Elemento encontrado no índice: {resultado}") # Mostra em que posição o elemento está na lista
else:
    print("Elemento não encontrado") # Mensagem que vai aparecer caso o elemento 7 não for encontrado
